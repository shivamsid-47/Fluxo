                                ...
                                <div className="animate-fade-in-up">
                                    ...
                                    {registrationRole === 'USER' && (
                                        <div className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-800 mb-2">User Registration</h3>
                                            ...
                                            <input placeholder="Phone" className="w-full p-3 bg-slate-50 rounded-xl font-bold outline-none text-sm" onChange={e => updateForm('phone', e.target.value)} />
                                            <button onClick={handleSubmitAuth} className="w-full py-3 bg-brand-blue text-white rounded-xl font-bold shadow-lg hover:bg-blue-600 mt-2">Sign Up</button>
                                        </div>
                                    )}
                                    ...
                                    {registrationRole === 'ORGANIZER_REGISTER' && (
                                        <div className="space-y-3">
                                            <h3 className="text-lg font-black text-slate-800 mb-2">Register Organization</h3>
                                            <input placeholder="Organization Name" className="w-full p-3 bg-slate-50 rounded-xl font-bold outline-none text-sm" onChange={e => updateForm('orgName', e.target.value)} />
                                            <input placeholder="Admin Email" className="w-full p-3 bg-slate-50 rounded-xl font-bold outline-none text-sm" onChange={e => updateForm('email', e.target.value)} />
                                            <input type="password" placeholder="Password" className="w-full p-3 bg-slate-50 rounded-xl font-bold outline-none text-sm" onChange={e => updateForm('password', e.target.value)} />
                                            <input placeholder="Contact Phone" className="w-full p-3 bg-slate-50 rounded-xl font-bold outline-none text-sm" onChange={e => updateForm('phone', e.target.value)} />
                                            <button onClick={handleSubmitAuth} className="w-full py-3 bg-brand-orange text-white rounded-xl font-bold shadow-lg hover:bg-orange-600 mt-2">Submit Request</button>
